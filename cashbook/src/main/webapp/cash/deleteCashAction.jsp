...
<%
	...
	if(PW.equals(pass)){
		...
		response.sendRedirect("/cashbook/dateList.jsp?cashDate="+c.getCashDate());
	}
	else{
		System.out.println("비밀번호가 틀렸습니다");
		response.sendRedirect("/cashbook/cash/deleteCashForm.jsp?cashNo="+cashNo+"&kind="+encodedKind);
	}
